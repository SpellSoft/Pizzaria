    ...
    public partial class Tabelas : DbMigration
    {
        public override void Up()
        {
                ...
                c => new
                    {
                        ...
                        Celular = c.String(maxLength: 13, unicode: false, storeType: "nvarchar"),
                    })
                .PrimaryKey(t => t.ClienteID)
            ...
            CreateTable(
                ...
                .PrimaryKey(t => t.ClienteID)
                .ForeignKey("dbo.Bairro", t => t.BairroID, cascadeDelete: true)
                .ForeignKey("dbo.Cidade", t => t.CidadeID, cascadeDelete: true)
                .ForeignKey("dbo.Cliente", t => t.ClienteID)
                .ForeignKey("dbo.Logradouro", t => t.LogradouroID, cascadeDelete: true)
                .Index(t => t.BairroID)
                .Index(t => t.CidadeID)
                .Index(t => t.ClienteID)
